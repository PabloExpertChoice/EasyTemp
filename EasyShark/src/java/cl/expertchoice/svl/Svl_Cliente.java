        ...
        try {
            ...
            switch (accion) {
                ...
                case "getActividadComercial": {
                    ...
                    Subsidiary cli = new WebServiceConsultas().consultarActividadComercial(Integer.parseInt(rut), dv);
                    if (cli != null) {
                        json.addProperty("estado", 200);
                ...
                case "validarQuiebra": {
                    ...
                    Quiebra q = new BnSubsidiary().consultarQuiebra(Integer.parseInt(rut));
                    if (q != null) {
