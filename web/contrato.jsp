                                        ...
                                        <li class="dropdown dropdown-extended dropdown-tasks dropdown-dark" id="header_task_bar">
                                            ...
                                            <ul class="dropdown-menu extended tasks">
                                                <li class="external">
                                                    ...
                                                    <a href="components_bootstrap_switch9329.html?p=page_todo_2">view all</a>
                                                </li>
                                                <li>
                                                    <ul class="dropdown-menu-list scroller" style="height: 275px;" data-handle-color="#637283">
                                                        <li>
                                                        ...
                                                        <li class="nav-item">
                                                            ...
                                                            <ul class="sub-menu">
                                                                <li class="nav-item">
                                                                    ...
                                                                    <ul class="sub-menu">
                                                                        <li class="nav-item">
                                                                            <a href="components_bootstrap_switchb212.html?p=dashboard-2" target="_blank" class="nav-link">
