                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="hpanel filter-item">
                                    <div class="panel-body">
                                        <div class="pull-right text-right">
                                            <div class="toggle btn btn-default off" data-toggle="toggle" style="width: 61px; height: 34px;">
                                                <input id="evento-toggle2" data-toggle="toggle" data-on="SI" data-off="NO" type="checkbox">
                                ...
                                <div class="hpanel filter-item">
                                    <div class="panel-body">
                                        <div class="pull-right text-right">
                                            <div class="toggle btn btn-default off" data-toggle="toggle" style="width: 61px; height: 34px;"><input id="evento-toggle3" data-toggle="toggle" data-on="SI" data-off="NO" type="checkbox"><div class="toggle-group"><label class="btn btn-primary toggle-on">SI</label><label class="btn btn-default active toggle-off">NO</label><span class="toggle-handle btn btn-default"></span></div></div>
                                        </div>
                                ...
                                <div class="hpanel filter-item">
                                    <div class="panel-body">
                                        <div class="pull-right text-right">
                                            <div class="toggle btn btn-default off" data-toggle="toggle" style="width: 61px; height: 34px;"><input id="evento-toggle4" data-toggle="toggle" data-on="SI" data-off="NO" type="checkbox"><div class="toggle-group"><label class="btn btn-primary toggle-on">SI</label><label class="btn btn-default active toggle-off">NO</label><span class="toggle-handle btn btn-default"></span></div></div>
                                        </div>
